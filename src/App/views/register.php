    ...
    <form class="grid grid-cols-1 gap-6" method="POST" >
        ...
        <label class="block">
            ...
            <?php if (isset($errors['email'])): ?>
                <p class="text-red-500 text-sm mt-1"><?= e($errors['email'][0]); ?></p>
            <?php endif; ?>
        </label>
        <!-- Age -->
        <label class="block">
            ...
            <?php if (isset($errors['age'])): ?>
                <p class="text-red-500 text-sm mt-1"><?= e($errors['age'][0]); ?></p>
            <?php endif; ?>
        </label>
        <!-- Country -->
        <label class="block">
            ...
            <?php if (isset($errors['country'])): ?>
                <p class="text-red-500 text-sm mt-1"><?= e($errors['country'][0]); ?></p>
            <?php endif; ?>
        </label>
        <!-- Social Media URL -->
        <label class="block">
            ...
            <input
                    ...
                    placeholder=""
            />
            <?php if (isset($errors['socialMediaUrl'])): ?>
                <p class="text-red-500 text-sm mt-1"><?= e($errors['socialMediaUrl'][0]); ?></p>
            <?php endif; ?>
        </label>
        <!-- Password -->
        <label class="block">
        ...
        <label class="block">
            ...
            <?php if (isset($errors['confirmPassword'])): ?>
                <p class="text-red-500 text-sm mt-1"><?= e($errors['confirmPassword'][0]); ?></p>
            <?php endif; ?>
        </label>
        <!-- Terms of Service -->
        <div class="block">
